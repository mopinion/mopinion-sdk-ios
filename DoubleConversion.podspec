...
Pod::Spec.new do |s|
  ...
  s.version      = "0.1.0"
  s.summary      = "Mopinion SDK for iOS React"
  ...
  s.description  = "Mopinion iOS SDK React"
  ...
  s.ios.vendored_frameworks = 'DoubleConversion.framework'
#   s.source_files  = "DoubleConversion/"
