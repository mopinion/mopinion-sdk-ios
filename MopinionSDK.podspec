#
#  Be sure to run `pod spec lint MopinionSDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = "Mopinion iOS SDK"
...
#   s.license      = "MIT"
  ...
  s.author             = { "Floris Snuif" => "floris@mopinion.com" }
  # Or just: s.author    = "Floris Snuif"
  # s.authors            = { "Floris Snuif" => "floris@mopinionlabs.com" }
  # s.social_media_url   = "http://twitter.com/Floris Snuif"
...
#   s.platform     = :ios
  ...
  # s.source_files  = "MopinionSDK.framework", "main.jsbundle"
  ...
  # s.resource  = "MopinionSDK.framework/main.jsbundle"
...
#   s.dependency 'React', :git => "https://github.com/mopinion/mopinion-sdk-ios.git", :version => "0.51.0"
#   s.dependency 'yoga', :git => "https://github.com/mopinion/mopinion-sdk-ios.git", :version => "0.1.0"
#   s.dependency 'DoubleConversion', :git => "https://github.com/mopinion/mopinion-sdk-ios.git", :version => "0.1.0"
#   s.dependency 'GLog', :git => "https://github.com/mopinion/mopinion-sdk-ios.git", :version => "0.1.0"
#   s.dependency 'Folly', :git => "https://github.com/mopinion/mopinion-sdk-ios.git", :version => "0.1.0"
